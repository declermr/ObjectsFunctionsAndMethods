...
def try_methods_and_functions():
    ...
    maddy = rg.SimpleTurtle()
    maddy.pen = rg.Pen('blue', 5)

    maddy.backward(150)
    maddy.speed = 1
    draw_many_squares(maddy,2,100,30)
    maddy.speed = 5
    maddy.pen = rg.Pen('red', 5)
    draw_many_squares(maddy,10,50,15)
    maddy.speed = 100
    maddy.pen = rg.Pen('red', 35)
    draw_many_squares(maddy,8,300,60)
    maddy.pen = rg.Pen('black',3)
    maddy.backward(200)
    maddy.draw_circle(30)
    maddy.draw_square(50)
